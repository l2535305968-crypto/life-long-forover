...
async function onRequestPost2(context) {
  ...
  const messages = body.messages.slice(0, 60).map((m) => ({ role: m && m.role, content: String(m && m.content || "") })).filter((m) => (m.role === "system" || m.role === "user" || m.role === "assistant") && m.content);
  if (!messages.length) {
  ...
  const payload = {
    ...
    max_tokens: Math.min(Math.max(Number(body.max_tokens) || 700, 32), 3e3),
    stream: false
  };
  try {
    ...
    if (!upstream.ok) {
      const hint = upstream.status === 401 ? "Key \u4E0D\u5BF9\u6216\u8FC7\u671F" : upstream.status === 402 ? "\u8D26\u6237\u4F59\u989D\u4E0D\u591F" : upstream.status === 429 ? "\u4E0A\u6E38\u9650\u6D41\u4E86\uFF0C\u7B49\u4E00\u4F1A\u513F" : upstream.status >= 500 ? "\u4E0A\u6E38\u670D\u52A1\u51FA\u9519" : "\u4E0A\u6E38\u62D2\u7EDD\u4E86\u8FD9\u6B21\u8BF7\u6C42";
...
async function onRequestPost3(context) {
  ...
  try {
    ...
    return json2(400, { ok: false, code: "BAD_JSON", error: "\u8BF7\u6C42\u4E0D\u662F\u5408\u6CD5 JSON" });
  }
...
// ../.wrangler/tmp/pages-5ySbTi/functionsRoutes-0.9047169949923621.mjs
var routes = [
  {
    routePath: "/api/asr",
    mountPath: "/api",
...
// C:/Users/l2535/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/l2535/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/l2535/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/l2535/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// C:/Users/l2535/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
//# sourceMappingURL=functionsWorker-0.4655339008174907.mjs.map
